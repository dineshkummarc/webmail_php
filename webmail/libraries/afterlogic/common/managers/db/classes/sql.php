...
class CDbSchemaHelper
{
	...
	public static function GetSqlTables()
	{
		...
		CDbSchemaHelper::addTablesToArray($aTables, array(
			...
			'awm_subadmins', 'awm_subadmin_domains',
...
class CDbSchema
{
	...
	public static function AwmSettings()
	{
		return new CDbTable('awm_settings', CDbSchemaHelper::Prefix(), array(
			...
			new CDbField('def_date_fmt', CDbField::VAR_CHAR, 'MM/DD/YY'),
	 ...
	 * @return CDbTable
	 */
	public static function AwmSubadmins()
	{
		return new CDbTable('awm_subadmins', CDbSchemaHelper::Prefix(), array(
			new CDbField('id_admin', CDbField::AUTO_INT),
			new CDbField('is_owner', CDbField::BIT, 0),
			...
			new CDbKey(CDbKey::TYPE_PRIMARY_KEY, array('id_admin'))
		));
	}
	 ...
	 * @return CDbTable
	 */
	public static function AwmSubadminDomains()
	{
		return new CDbTable('awm_subadmin_domains', CDbSchemaHelper::Prefix(), array(
			new CDbField('id', CDbField::AUTO_INT),
			new CDbField('id_admin', CDbField::INT),
			new CDbField('id_domain', CDbField::INT)
		), array(
			new CDbKey(CDbKey::TYPE_PRIMARY_KEY, array('id')),
			new CDbKey(CDbKey::TYPE_KEY, array('id_admin'))
		));
	}
...
//			new CDbField('autoaddinvitation', CDbField::BIT, 0),
	...
	public static function AdavAddressbooks()
	{
		return new CDbTable('adav_addressbooks', CDbSchemaHelper::Prefix(), array(
			...
			new CDbField('uri', CDbField::VAR_CHAR, null, 100),
	...
	public static function AdavPrincipals()
	{
		return new CDbTable('adav_principals', CDbSchemaHelper::Prefix(), array(
			new CDbField('id', CDbField::AUTO_INT_UNSIGNED),
			new CDbField('uri', CDbField::VAR_CHAR, null, 100, true),
