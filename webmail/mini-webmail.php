...
<head>
	...
	<script type="text/javascript">
		...
		var CsrfToken = "<?php echo ConvertUtils::ClearJavaScriptString($sCsrfToken, '"'); ?>";
		var WebMail = {
...
// TODO
//		if (($oAccount->ViewMode == VIEW_MODE_PREVIEW_PANE_NO_IMG ||
//			$oAccount->ViewMode == VIEW_MODE_WITHOUT_PREVIEW_PANE_NO_IMG) && !$_isFromSave)
		if (!$_isFromSave)
		{
			echo '
