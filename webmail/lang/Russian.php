...
define('AppointmentMoreInfo', 'Побробнее');
...
define('AppointmentRespondYes', 'Прийду');
define('AppointmentRespondMaybe', 'Неуверен');
...
define('FiltersCondContainSubstr', 'соджержит слово');
...
define('SettingsTabMobileSync', 'Cинхронизация');
...
define('DialogAttachTypeNo', 'Без аттачмента');
...
define('DialogAttachTypeTxtAttach', 'Plain Text (.txt) аттачмент');
