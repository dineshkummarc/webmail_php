...
module.exports = {
   ...
   * @param {array} aScopes New value of Scopes parameter.
   */
  updateAdmin: function updateAdmin(bEnableModule, sId, sSecret, sKey, aScopes) {
...
module.exports = function (oAppData) {
  var _ = __webpack_require__(/*! underscore */ "C3HO"),
    ...
    Settings = __webpack_require__(/*! modules/Google/js/Settings.js */ "Ijys");
    ...
    return {
      start: function start(ModulesManager) {
        ModulesManager.run('SettingsWebclient', 'registerSettingsTab', [function () {
          return __webpack_require__(/*! modules/Google/js/views/GoogleSettingsFormView.js */ "lcFO");
        }, Settings.HashModuleName, TextUtils.i18n('GOOGLE/LABEL_SETTINGS_TAB')]);
      }
    };
  }
  return null;
...
CGoogleSettingsFormView.prototype.connect = function (aScopes) {
  ...
  this.bRunCallback = false;
  var oWin = WindowOpener.open(UrlUtils.getAppPath() + '?oauth=google-connect', 'Google'),
