...
module.exports = function (oAppData) {
  var _ = __webpack_require__(/*! underscore */ "C3HO"),
    ...
    Settings = __webpack_require__(/*! modules/Dropbox/js/Settings.js */ "z+cb");
    ...
    return {
      start: function start(ModulesManager) {
        ModulesManager.run('SettingsWebclient', 'registerSettingsTab', [function () {
          return __webpack_require__(/*! modules/Dropbox/js/views/DropboxSettingsFormView.js */ "goct");
        }, Settings.HashModuleName, TextUtils.i18n('DROPBOX/LABEL_SETTINGS_TAB')]);
      }
    };
  }
  return null;
...
CDropboxSettingsFormView.prototype.connect = function (aScopes) {
  ...
  this.bRunCallback = false;
  var oWin = WindowOpener.open(UrlUtils.getAppPath() + '?oauth=dropbox-connect', 'Dropbox'),
