...
module.exports = function (oAppData) {
  __webpack_require__(/*! modules/StandardLoginFormWebclient/js/enums.js */ "F/HW");
  ...
  var Types = __webpack_require__(/*! modules/CoreWebclient/js/utils/Types.js */ "ERH9"),
    ...
    Settings = __webpack_require__(/*! modules/StandardLoginFormWebclient/js/Settings.js */ "++wR"),
    ...
    if (App.isMobile()) {
      return {
        ...
        getLoginScreenView: function getLoginScreenView() {
          return __webpack_require__(/*! modules/StandardLoginFormWebclient/js/views/LoginView.js */ "frIg");
        },
...
function CLoginView() {
  ...
  this.headingSelectLanguage = ko.computed(function () {
    ...
    return TextUtils.i18n('STANDARDLOGINFORMWEBCLIENT/HEADING_SELECT_LANGUAGE', {
      'SITENAME': sSiteName
    });
  }, this);
  ...
  App.broadcastEvent('StandardLoginFormWebclient::ConstructView::after', {
...
CLoginView.prototype.signIn = function () {
  ...
  if (!this.loading() && '' !== $.trim(this.login())) {
    ...
    App.broadcastEvent('AnonymousUserForm::PopulateFormSubmitParameters', {
      Module: 'StandardLoginFormWebclient',
