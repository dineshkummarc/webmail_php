...
//				}
			...
			$sEmail = $oAccountNode->GetChildValueByTagName('email');

			/* custom class */
//			wm_Custom::StaticUseMethod('ChangeFakeEmailToAccountEmail', array(&$sEmail));
	...
	public static function GetContact($oRequestXml, $oAccount)
	{
		...
		$oContact->SurName = $oContactNode->GetChildValueByTagName('surname', true);
