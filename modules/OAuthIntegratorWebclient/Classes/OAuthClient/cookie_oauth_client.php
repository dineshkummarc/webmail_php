...
class cookie_oauth_client_class extends oauth_client_class
{
    public $session = '';
    public $key = '';
    public $cookie_name = 'OAuth_session';
    public $cookie_value;
    public $cipher = '';
    public $openssl_default_cipher = 'bf-ofb';
    public $mcrypt_default_cipher = 'blowfish-compat-ofb';


    public function EncodeText($text, $context, &$error)
    {
        $error = '';
        $encode_time = time();
    ...
    public function DecodeText($encoded, &$encode_time, &$error)
    {
        $error = '';
