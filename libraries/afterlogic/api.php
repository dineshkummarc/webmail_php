...
class CApi
{
	 ...
	 * @return string
	 */
	public static function GetCsrfToken($bCreate = true)
	{
		$sCsrfToken = CSession::Get(API_SESSION_CSRF_TOKEN, '');
		if (empty($sCsrfToken) && $bCreate)
		{
			$sCsrfToken = md5(microtime(true).rand(1000, 9999));
			CSession::Set(API_SESSION_CSRF_TOKEN, $sCsrfToken);
		}
