...
class afterlogic_DAV_Delegates_Root extends Sabre_DAV_Directory {
    ...
    function getChildren() {
        ...
        while($row = $stmt->fetch(PDO::FETCH_ASSOC)) {
            ...
            $calendars[] = new afterlogic_DAV_Delegates_CalendarParent($this->pdo, $this->principalBackend, $this->calendarBackend, $calendar);
    ...
    function getChild($name) {
        ...
        // Making fields a comma-delimited list 
        $fields = implode(', ', $fields);
		$this->calendarBackend->calendarTableName;
        ...
        return new afterlogic_DAV_Delegates_CalendarParent($this->pdo, $this->principalBackend, $this->calendarBackend, $calendar);
