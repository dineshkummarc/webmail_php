...
class CApiContactsManager extends AApiManagerWithStorage
{
	...
	{
		parent::__construct('contacts', $oManager);
	...
	public function GetSuggestItems($oAccount, $sSearch = '', $iRequestLimit = 20)
	{
		...
		try
		{
			...
			if ($iRequestLimit > count($mResult))
			{
	...
	{
		CApi::Inc('common.ics.reader');
		CApi::Inc('common.ics.parser');
		CApi::Inc('common.ics.formatter');
