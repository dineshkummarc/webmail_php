...
class api_Settings
{
	...
	protected function initDefaultValues()
	{
		$this->aMap = array(
			...
			'Common/AdminPassword' => array('12345', 'string'),
			...
			'StorageTypes/Subadmins' => array('db', 'string'),
			'StorageTypes/Contacts' => array('db', 'string'),
			'StorageTypes/Users' => array('db', 'string'),
			'StorageTypes/WebMail' => array('db', 'string'),
			'StorageTypes/Calendar' => array('caldav', 'string')
		);
