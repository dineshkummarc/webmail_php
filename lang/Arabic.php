...
define('WebMailException', 'حدث خطأ غير معروف');
...
define('JS_LANG_InfoWebMailLoading', 'الرجاء الانظار حتى يتم تحميل البريد&hellip;');
define('JS_LANG_Loading', 'تحميل&hellip;');
define('JS_LANG_InfoMessagesLoad', 'الرجاء الانتظار حتى يتم تحميل قائمة الرسائل');
define('JS_LANG_InfoEmptyFolder', 'المجلد فارغ');
define('JS_LANG_InfoPageLoading', 'الصفحة لا تزال قيد التحميل&hellip;');
...
define('JS_LANG_WarningEmptySearchLine', 'لايجد كلمة بحث. فضلا ادخل كلمة على الأقل لتنفيذ البحث');
...
define('JS_LANG_LoggingToServer', 'تسجيل الدخول إلى الخادم&hellip;');
define('JS_LANG_GettingMsgsNum', 'تحديد عدد الرسائل');
...
define('JS_LANG_ClassicVersion', 'نسخة كلاسيكية');
...
define('JS_LANG_AddToAddressBook', 'إضافة إلىجهات الاتصال');
define('JS_LANG_ClickToDownload', 'أضغط هنا لتحميل');
define('JS_LANG_View', 'عرض');
define('JS_LANG_ShowFullHeaders', 'عرض العنوان بالكامل');
define('JS_LANG_HideFullHeaders', ' إخفاء العنوان');
...
define('JS_LANG_UseFriendlyNm2', '(الاسم &lt;sender@mail.com&gt;)');
...
define('JS_LANG_OtherFilterSettings', 'إعدادات مرشحات أخرى');
...
define('JS_LANG_UseFriendlyName2', '(مثلا فيصل عبدالله &lt;johndoe@mail.com&gt;)');
...
define('SpellWait', 'الرجاء الانتظار&hellip;');
...
define('ToolNewEvent', 'مناسبة جديدة');
define('ToolBack', 'للخلف');
define('ToolToday', 'اليوم');
define('AltNewEvent', 'مناسبة جديدة');
...
define('EventHeaderNew', 'مناسبة جديدة');
...
define('InfoDeleting', 'جاري تنفيذ عملية الحذف&hellip;');
...
define('InfoLoading', 'تحميل&hellip;');
...
define('InfoSaving', 'جاري الحفظ&hellip;');
...
define('ShortMonthJanuary', 'يناير');
define('ShortMonthFebruary', 'فبراير');
define('ShortMonthMarch', 'مارس');
define('ShortMonthApril', 'أبريل');
define('ShortMonthMay', 'مايو');
define('ShortMonthJune', 'يونيو');
define('ShortMonthJuly', 'يوليو');
define('ShortMonthAugust', 'أغسطس');
define('ShortMonthSeptember', 'سبتمبر');
define('ShortMonthOctober', 'أكتوبر');
define('ShortMonthNovember', 'نوفمبر');
define('ShortMonthDecember', 'ديسمبر');
...
define('DayToolMonday', 'الاثنين');
define('DayToolTuesday', 'الثلاثاء');
define('DayToolWednesday', 'الأربعاء');
define('DayToolThursday', 'الخميس');
define('DayToolFriday', 'الجمعة');
define('DayToolSaturday', 'السبت');
define('DayToolSunday', 'الأحد');

define('CalendarTableDayMonday', 'ن');
define('CalendarTableDayTuesday', 'ث');
define('CalendarTableDayWednesday', 'ر');
define('CalendarTableDayThursday', 'خ');
define('CalendarTableDayFriday', 'ج');
define('CalendarTableDaySaturday', 'س');
define('CalendarTableDaySunday', 'ح');

define('ErrorParseJSON', 'لم يمكن من معالجة بيانات ملف الـ JSON الذي تم إرجاعه من الخادم.');
...
define('WarningEmailFieldFilling', 'يجب تعبئة حقل البريد الإلكتروني أولاً');
define('EventHeaderView', 'عرض الحدث');
define('ErrorUpdateSharing', 'لم يتمكن من حفظ بيانات النشر والمشاركة');
define('ErrorUpdateSharing1', 'لا يمكن المشاركة مع  %s لأن المستخدم غير موجود');
define('ErrorUpdateSharing2', 'لا يمكن مشاركة هذا التقويم مع المستخدم %s');
define('ErrorUpdateSharing3', 'هذا التقوم مشارك مسبقا مع المستخدم  %s');
define('Title_MyCalendars', 'تقاويمي');
define('Title_SharedCalendars', 'التقاويم المشتركة');
define('ErrorGetPublicationHash', 'لم يتمكن نم إنشاء روابط النشر');
define('ErrorGetSharing', 'لم يتمكن من إضافة مشاركة');
define('CalendarPublishedTitle', 'تم نشر هذا التقويم');
define('RefreshSharedCalendars', 'تحديث التقاويم المشتركة');
define('Title_CheckSharedCalendars', 'Reload Calendars');

define('GroupMembers', 'الأعضاء');

define('ReportMessagePartDisplayed', 'علما بأن مجرد جزء من الرسالة عرض.');
define('ReportViewEntireMessage', 'لعرض الرسالة كاملة,');
define('ReportClickHere', 'اضغط هنا');
define('ErrorContactExists', 'العنوان الذي تحاول إضافته موجود مسبقا.');

define('Attachments', 'مرفقات');

define('InfoGroupsOfContact', 'المجموعات التي ينتمي إليها هذا العضو تم تحديدها بعلامات اختيار.');
define('AlertNoContactsSelected', 'لم يتم اختيار أي جهة اتصال.');
define('MailSelected', 'راسل العناوين التي تم اختيارها');
define('CaptionSubscribed', 'مشترك');

define('OperationSpam', 'رسائل غير مرغوب فيها');
define('OperationNotSpam', 'ليست رسائل غير مرغوب فيها');
define('FolderSpam', 'رسائل غير مرغوب فيها');

// webmail 4.4 contacts
define('ContactMail', 'راسل جهة الاتصال');
define('ContactViewAllMails', 'عرض جميع الرسائل لجهة الاتصال');
define('ContactsMailThem', 'ارسل بريد للجميع');
...
define('MessageForAddr', 'إلى');
define('SearchClear', 'تفريغ نموذج البحث');
// Search results for "search string" in Inbox folder:
define('SearchResultsInFolder', 'نتيجة البحث عن  "#s" في مجلد   #f :');
// Search results for "search string" in all mail folders:
define('SearchResultsInAllFolders', 'نتيجة البحث عن  "#s" في جميع المجلدات:');
define('AutoresponderTitle', 'رد تلقائي');
define('AutoresponderEnable', 'تفعيل الرد التلقائي');
define('AutoresponderSubject', 'الموضوع');
define('AutoresponderMessage', 'الرسالة');
define('ReportAutoresponderUpdatedSuccessfuly', 'تمتحديث خاصية الرد التلقائي بنجاح.');
define('FolderQuarantine', 'حجر');

define('EventRepeats', 'تكرار');
define('NoRepeats', 'بدون تكرار');
define('DailyRepeats', 'يومي');
define('WorkdayRepeats', 'كل أيام الأسبوع (الاثنين. -الجمعة.)');
define('OddDayRepeats', 'كل اثنين وأربعاء وجمعة.');
define('EvenDayRepeats', 'كل يوم ثلاثاء وخميس');
...
define('ConfirmEditRepeatEvent', 'هل ترغب في تغيير هذه المناسبة وجميع المناسبات فقط, أو هذه المناسبة وجميع المناسبات المستقبلية في هذه السلسلة?');
define('RepeatEventHeaderEdit', 'تعديل المناسبات الدورية');
define('First', 'الأول');
...
define('Last', 'الأخير');
define('Every', 'كل');
define('SetRepeatEventEnd', 'حدد نهاية الحدث');
define('NoEndRepeatEvent', 'لايوجد تاريخ نهاية الحدث');
define('EndRepeatEventAfter', 'ايقاف الحدث بعد');
define('Occurrences', 'مرات');
define('EndRepeatEventBy', 'إنهاء بتاريخ');
define('EventCommonDataTab', 'التفاصيل الرئيسية');
define('EventRepeatDataTab', 'تفاصيل التكرار');
define('RepeatEventNotPartOfASeries', 'تم تغيير هذه المناسبة ولم تعد جزءا من السلسلة.');
define('UndoRepeatExclusion', 'تراجع عن التغيير.');

define('MonthMoreLink', '%d المزيد...');
define('NoNewSharedCalendars', 'لايوجد تقويم جديد');
define('NNewSharedCalendars', '%d تم العثور على تقويم جديد');
define('OneNewSharedCalendars', 'تم العثور على تقويم واحد ');
define('ConfirmUndoOneRepeat', 'هل ترغب في إعادة هذه المناسبة إلى سلسلة الأحداث?');

define('RepeatEveryDayInfin', 'كل يوم');
define('RepeatEveryDayTimes', 'كل يوم, %TIMES% مرات');
define('RepeatEveryDayUntil', 'كل يوم, حتى %UNTIL%');
define('RepeatDaysInfin', 'كل %PERIOD% أيام');
define('RepeatDaysTimes', 'كل %PERIOD% أيام, %TIMES% مرات');
define('RepeatDaysUntil', 'كل %PERIOD% أيام, حتى %UNTIL%');

define('RepeatEveryWeekWeekdaysInfin', 'كل أسبوع في أيام ايام العمل');
define('RepeatEveryWeekWeekdaysTimes', 'كل أسبوع في أيام ايام العمل, %TIMES% مرات');
define('RepeatEveryWeekWeekdaysUntil', 'كل أسبوع في أيام ايام العمل, حتى %UNTIL%');
define('RepeatWeeksWeekdaysInfin', 'كل %PERIOD% أسبوع في أيام العمل');
define('RepeatWeeksWeekdaysTimes', 'كل %PERIOD% أسبوع في أيام العمل, %TIMES% مرات');
define('RepeatWeeksWeekdaysUntil', 'كل %PERIOD% أسبوع في أيام العمل, حتى %UNTIL%');

define('RepeatEveryWeekInfin', 'كل أسبوع في يوم %DAYS%');
define('RepeatEveryWeekTimes', 'كل أسبوع في يوم %DAYS%, %TIMES% مرة');
define('RepeatEveryWeekUntil', 'في كل أسبوع في يوم %DAYS%, حتى تاريخ %UNTIL%');
define('RepeatWeeksInfin', 'كل %PERIOD% أسابيع في يوم %DAYS%');
define('RepeatWeeksTimes', 'كل %PERIOD% أسابيع في يوم %DAYS%, %TIMES% مرة');
define('RepeatWeeksUntil', 'كل %PERIOD% أسابيع في يوم %DAYS%, حتى تاريخ %UNTIL%');

define('RepeatEveryMonthDateInfin', 'في كل شهر في يوم %DATE%');
define('RepeatEveryMonthDateTimes', 'في كل شهر في يوم %DATE%, %TIMES% مرة');
define('RepeatEveryMonthDateUntil', 'في كل شهر في يوم %DATE%, حتى تاريخ %UNTIL%');
define('RepeatMonthsDateInfin', 'كل %PERIOD% أشهر في يوم %DATE%');
define('RepeatMonthsDateTimes', 'كل %PERIOD% أشهر في يوم %DATE%, %TIMES% مرة');
define('RepeatMonthsDateUntil', 'كل %PERIOD% أشهر في يوم %DATE%, حتى تاريخ %UNTIL%');

define('RepeatEveryMonthWDInfin', 'في كل شهر في %NUMBER% %DAY%');
define('RepeatEveryMonthWDTimes', 'في كل شهر في %NUMBER% %DAY%, %TIMES% مرة');
define('RepeatEveryMonthWDUntil', 'في كل شهر في %NUMBER% %DAY%, حتى تاريخ %UNTIL%');
define('RepeatMonthsWDInfin', 'كل %PERIOD% أشهر في يوم %NUMBER% %DAY%');
define('RepeatMonthsWDTimes', 'كل %PERIOD% أشهر في يوم %NUMBER% %DAY%, %TIMES% مرة');
define('RepeatMonthsWDUntil', 'كل %PERIOD% أشهر في يوم %NUMBER% %DAY%, حتى تاريخ %UNTIL%');

define('RepeatEveryYearDateInfin', 'في كل سنة في يوم %DATE%');
define('RepeatEveryYearDateTimes', 'في كل سنة في يوم %DATE%, %TIMES% مرة');
define('RepeatEveryYearDateUntil', 'في كل سنة في يوم %DATE%, حتى تاريخ %UNTIL%');
define('RepeatYearsDateInfin', 'كل %PERIOD% سنوات في يوم %DATE%');
define('RepeatYearsDateTimes', 'كل %PERIOD% سنوات في يوم %DATE%, %TIMES% مرة');
define('RepeatYearsDateUntil', 'كل %PERIOD% سنوات في يوم %DATE%, حتى تاريخ %UNTIL%');

define('RepeatEveryYearWDInfin', 'في كل سنة في %NUMBER% %DAY%');
define('RepeatEveryYearWDTimes', 'في كل سنة في %NUMBER% %DAY%, %TIMES% مرة');
define('RepeatEveryYearWDUntil', 'في كل سنة في %NUMBER% %DAY%, حتى تاريخ %UNTIL%');
define('RepeatYearsWDInfin', 'كل %PERIOD% سنوات في يوم %NUMBER% %DAY%');
define('RepeatYearsWDTimes', 'كل %PERIOD% سنوات في يوم %NUMBER% %DAY%, %TIMES% مرة');
define('RepeatYearsWDUntil', 'كل %PERIOD% سنوات في يوم %NUMBER% %DAY%, حتى تاريخ %UNTIL%');
...
// webmail 4.5.x new
define('EmptySpam', 'تفريغ البريد المزعج');
define('Saving', 'جاري الحفظ&hellip;');
define('Sending', 'جاري الإرسال&hellip;');
define('LoggingOffFromServer', 'جاري تسجيل الخروج من الخادم&hellip;');

//webmail 4.6
define('PROC_CANT_SET_MSG_AS_SPAM', 'لا يمكن تعليم الرسالة/الرسائل كبريد مزعج');
define('PROC_CANT_SET_MSG_AS_NOTSPAM', 'لا يمكن تعليم الرسالة/الرسائل كبريد غير مزعج');
define('ExportToICalendar', 'التصدير إلى التقويم');
define('ErrorMaximumUsersLicenseIsExceeded', 'تم تعطيل حسابك بسبب الوصول للحد الأعلى من الحسابات لهذا الترخيص. الرجاء الاتصال بالمسؤل.');
define('RepliedMessageTitle', 'رسالة مجابة');
define('ForwardedMessageTitle', 'رسالة محولة');
define('RepliedForwardedMessageTitle', 'رسالة مجابة ومحولة');
define('ErrorDomainExist', 'لا يمكن إنشاء حساب البريد بسبب عدم وجود اسم نطاق . يجب إنشاء اسم النطاق أولاً.');
...
define('ReminderEmailExplanation', 'تصلك هذة الرسالة على حسابك  %EMAIL% بسبب تفعيلك لخاصية التذكير في نظام التقويم %CALENDAR_NAME%');
define('ReminderOpenCalendar', 'فتح التقويم');

define('AddReminder', 'ذكرني بهذه المناسبة');
define('AddReminderBefore', 'ذكرني  % قبل هذه المناسبة');
define('AddReminderAnd', 'و % قبل');
define('AddReminderAlso', 'وايضا % قبل');
define('AddMoreReminder', 'مذكرات اخرى');
define('RemoveAllReminders', 'مسح جميع المذكرات');
define('ReminderNone', 'لا شي');
define('ReminderMinutes', 'دقائق');
define('ReminderHour', 'ساعة');
define('ReminderHours', 'ساعات');
define('ReminderDay', 'يوم');
define('ReminderDays', 'أيام');
define('ReminderWeek', 'اسبوع');
define('ReminderWeeks', 'اسابيع');
define('Allday', 'كل اليوم');

define('Folders', 'مجلدات');
define('NoSubject', 'بدون موضوع');
define('SearchResultsFor', 'نتائج البحث عن');

define('Back', 'رجوع');
define('Next', 'تالي');
define('Prev', 'سابق');

define('MsgList', 'الرسائل');
define('Use24HTimeFormat', 'استخدم تنسيق 24 ساعة');
define('UseCalendars', 'استخدام التقويم');
define('Event', 'أحداث');
define('CalendarSettingsNullLine', 'لا توجد اي مذكرات');
define('CalendarEventNullLine', 'لا توجد مناسبات');
define('ChangeAccount', 'تغيير الحساب');

define('TitleCalendar', 'تقويم');
define('TitleEvent', 'مناسبة');
define('TitleFolders', 'مجلدات');
define('TitleConfirmation', 'تأكيد');

define('Yes', 'نعم');
define('No', 'لا');

define('EditMessage', 'تعديل الرسالة');

define('AccountNewPassword', 'كلمة مرور جديدة');
define('AccountConfirmNewPassword', 'تأكيد كلمة المرور');
define('AccountPasswordsDoNotMatch', 'كلمات المرور غير متطابقة.');

define('ContactTitle', 'اللقب');
define('ContactFirstName', 'الاسم الأول');
define('ContactSurName', 'اسم العائلة');
define('ContactNickName', 'الاسم المستعار');

define('CaptchaTitle', 'الصورة الأمنية');
define('CaptchaReloadLink', 'تحديث الصورة');
define('CaptchaError', 'النص المدخل غير مطابق للصورة الأمنية.');

define('WarningInputCorrectEmails', 'يرجى تجديد عناوين بريد إلكتروني صحيحة.');
define('WrongEmails', 'العناوين الخاطئة:');

define('ConfirmBodySize1', 'عفواً, لقد تعديت الحد الأقصى للرساله.');
define('ConfirmBodySize2', 'محتوى الرسالة طويل جداً. سيتم مسح المحتوى الزائد. إضغط "إلغاء" إذا كنت ترغب في تعديل الرسالة.');
define('BodySizeCounter', 'عداد');
define('InsertImage', 'إدراج صورة');
define('ImagePath', 'مسار الصورة');
define('ImageUpload', 'إدراج');
define('WarningImageUpload', 'الملف المرفق ليس صورة. الرجاء اختيار صورة.');

define('ConfirmExitFromNewMessage', 'لن يتم حفظ التغييرات إذا تركت الصفحة. هل ترغب في حفظ مسودة قبل ترك الصفحة؟');

define('SensivityConfidential', 'يرجى التعامل مع هذه الرسالة على أنها رسالة سرية');
define('SensivityPrivate', 'يرجى التعامل مع هذه الرسالة على أنها رسالة خاصة');
define('SensivityPersonal', 'يرجى التعامل مع هذه الرسالة على أنها رسالة شخصية');

define('ReturnReceiptTopText', 'لقد طلب المرسل أن يتم تبليغة بتأكيد استلامك للرسالة.');
define('ReturnReceiptTopLink', 'إضغط هنا ليتم إبلاغ المرسل بالاستلام.');
define('ReturnReceiptSubject', 'تأكيد استلام (عرض)');
define('ReturnReceiptMailText1', 'هذا تأكيد على استلام الرسالة المرسلة إلى');
define('ReturnReceiptMailText2', 'ملاحظة: هذا التقرير يأكد عرض محتوى الرسالة على جهاز المرسل إلية. ولكن لا يأكد على قراءة أو فهم محتوى الرسالة.');
define('ReturnReceiptMailText3', 'بعنوان');

define('SensivityMenu', 'الحساسية');
define('SensivityNothingMenu', 'لا شيء');
define('SensivityConfidentialMenu', 'سري');
define('SensivityPrivateMenu', 'خاص');
define('SensivityPersonalMenu', 'شخصي');

define('ErrorLDAPonnect', 'لا يمكن الاتصال بخادم ldap');

define('MessageSizeExceedsAccountQuota', 'حجم هذه الرسالة يتجاوز المساحة المخصصة لحسابك.');
define('MessageCannotSent', 'لا يمكن إرسال هذه الرسالة.');
define('MessageCannotSaved', 'لا يمكن حفظ هذه الرسالة.');

define('ContactFieldTitle', 'الحقل');
define('ContactDropDownTO', 'إلى');
define('ContactDropDownCC', 'نسخة');
define('ContactDropDownBCC', 'نسخة مخفية');

// 4.9 
define('NoMoveDelete', 'لا يمكن نقل الرسائل إلى المهملات. السبب الأرجح في ذلك هو أن صندوق الوارد ممتلئ. هل ترغب في حذف الرسائل التي لم يتم نقلها؟');

define('WarningFieldBlank', 'لا يمكن ترك هذا الحقل فارغاً.');
define('WarningPassNotMatch', 'كلمات المرور غير متطابقة. يرجى التحقق.');
define('PasswordResetTitle', 'استرجاع كلمة المرور - الخطوة %d');
define('NullUserNameonReset', 'اسم المستخدم');
define('IndexResetLink', 'نسيت كلمة المرور؟');
define('IndexRegLink', 'تسجيل حساب');

define('RegDomainNotExist', 'النطاق غير موجود.');
define('RegAnswersIncorrect', 'الإجابات غير صحيحة.');
define('RegUnknownAdress', 'عنوان بريد إلكتروني غير معروف.');
define('RegUnrecoverableAccount', 'لا يمكن استرجاع كلمة المرور لحساب هذا البريد.');
define('RegAccountExist', 'هذا الحساب مستخدم حالياً.');
define('RegRegistrationTitle', 'تسجيل');
define('RegName', 'الأسم');
define('RegEmail', 'عنوان البريد الإلكتروني');
define('RegEmailDesc', 'مثلاً: myname@domain.com سيتم استخدام هذه المعلومات لتسجيل الدخول.');
define('RegSignMe', 'تذكرني');
define('RegSignMeDesc', 'لا تسئل عن اسم المستخدم وكلمة المرور في المرات القادمة عند تسجيل الدخول من هذا الجهاز.');
define('RegPass1', 'كلمة المرور');
define('RegPass2', 'تأكيد كلمة المرور');
define('RegQuestionDesc', 'فضلاً قم بكتابة سؤالين سريه و الإجابة عليهم. سيتم عرضها عليك عند الحاجة إلى إستعادة كلمة المرور.');
define('RegQuestion1', 'السؤال السري الأول');
define('RegAnswer1', 'الإجابة الأولى');
define('RegQuestion2', 'السؤال السري الثاني');
define('RegAnswer2', 'الإجابة الثانية');
define('RegTimeZone', 'التوقيت الافتراضي');
define('RegLang', 'لغة الواجهة');
define('RegCaptcha', 'الصورة الأمنية');
define('RegSubmitButtonValue', 'تسجيل');

define('ResetEmail', 'يرجى تقديم البريد الإلكتروني الخاص بك');
define('ResetEmailDesc', 'قم بتقديم عناوين بريد إلكتروني تم استخدامها عند التسجيل.');
define('ResetCaptcha', 'الصورة الأمنية');
define('ResetSubmitStep1', 'إرسال');
define('ResetQuestion1', 'السؤال السري الأول');
define('ResetAnswer1', 'الإجابة');
define('ResetQuestion2', 'السؤال السري الثاني');
define('ResetAnswer2', 'الإجابة');
define('ResetSubmitStep2', 'إرسال');

define('ResetTopDesc1Step2', 'عناوين البريد الإلكتروني المقدمة');
define('ResetTopDesc2Step2', 'يرجى تأكيد صحة المعلومات.');

define('ResetTopDescStep3', 'يرجى تحديد كلمة مرور جديدة لحساب بريدك الإلكتروني.');

define('ResetPass1', 'كلمة المرور الجديدة');
define('ResetPass2', 'تأكيد كلمة المرور');
define('ResetSubmitStep3', 'إرسال');
define('ResetDescStep4', 'تم تغيير كلمة المرور الخاصة بك.');
define('ResetSubmitStep4', 'العودة');

define('RegReturnLink', 'العودة لصفحة تسجيل الدخول');
define('ResetReturnLink', 'العودة لصفحة تسجيل الدخول');

// Appointments 
define('AppointmentAddGuests', 'إضافة مدعوين');
define('AppointmentRemoveGuests', 'إلغاء الإجتماع');
define('AppointmentListEmails', 'قم بإدخال الحسابات البريدية مفصولة بعلامة , ثم إضغط حفظ');
define('AppointmentParticipants', 'المشاركون');
define('AppointmentRefused', 'رفض');
define('AppointmentAwaitingResponse', 'في إنتظار الرد');
define('AppointmentInvalidGuestEmail', 'العناوين البريدية التالية والخاصة بالمدعوين غير صحيحة:');
define('AppointmentOwner', 'المالك');

define('AppointmentMsgTitleInvite', 'دعوة لحدث');
define('AppointmentMsgTitleUpdate', 'تم تعديل الحدث.');
define('AppointmentMsgTitleCancel', 'تم إلغاء الحدث.');
define('AppointmentMsgTitleRefuse', 'المدعو %guest% رفض الدعوة');
define('AppointmentMoreInfo', 'المزيد من المعلومات');
define('AppointmentOrganizer', 'المنظم');
define('AppointmentEventInformation', 'معلومات الحدث');
define('AppointmentEventWhen', 'عندما');
define('AppointmentEventParticipants', 'المشاركون');
define('AppointmentEventDescription', 'الوصف');
define('AppointmentEventWillYou', 'هل ستشارك');
define('AppointmentAdditionalParameters', 'معلومات إضافية');
define('AppointmentHaventRespond', 'لم يتم الرد بعد');
define('AppointmentRespondYes', 'سوف أشارك');
define('AppointmentRespondMaybe', 'لست متأكداً');
define('AppointmentRespondNo', 'لن أشارك');
define('AppointmentGuestsChangeEvent', 'يمكن للمدعوين التعديل على الحدث');

define('AppointmentSubjectAddStart', 'لقد تلقيت دعوة للحدث ');
define('AppointmentSubjectAddFrom', ' من ');
define('AppointmentSubjectUpdateStart', 'الأحداث المعدلة ');
define('AppointmentSubjectDeleteStart', 'الأحداث الملغاء ');
define('ErrorAppointmentChangeRespond', 'لا يمكن التعديل على رد الموعد');
define('SettingsAutoAddInvitation', 'إضافة الدعوات تلقائياً إلى التقويم');
define('ReportEventSaved', 'تم حفظ الحدث');
define('ReportAppointmentSaved', ' and notifications were send');
define('ErrorAppointmentSend', 'لا يمكن إرسال الدعوات.');
define('AppointmentEventName', 'الاسم:');

// End appointments

define('ErrorCantUpdateFilters', 'لا يمكن تحديث المرشحات');

define('FilterPhrase', 'If there\'s %field header %condition %string then %action');
define('FiltersAdd', 'إضافة مرشح');
define('FiltersCondEqualTo', 'يساوي لـ');
define('FiltersCondContainSubstr', 'تتضمن جزء من النص');
define('FiltersCondNotContainSubstr', 'لا يتضمن جزء من النص');
define('FiltersActionDelete', 'حذف الرسالة');
define('FiltersActionMove', 'نقل');
define('FiltersActionToFolder', 'إلى مجلد %folder');
define('FiltersNo', 'لم يتم تحديد مرشحات حتى الأن');

define('ReminderEmailFriendly', 'تذكير');
define('ReminderEventBegin', 'يبدأ في: ');

define('FiltersLoading', 'تحميل المرشحات...');
define('ConfirmMessagesPermanentlyDeleted', 'سيتم حذف جميع الرسائل في هذا المجلد بشكل مستمر.');

define('InfoNoNewMessages', 'لا توجد رسائل جديدة.');
define('TitleImportContacts', 'استيراد جهات الاتصال');
define('TitleSelectedContacts', 'جهات الاتصال المحددة');
define('TitleNewContact', 'جهة اتصال جديدة');
define('TitleViewContact', 'عرض جهة الاتصال');
define('TitleEditContact', 'تعديل جهة الاتصال');
define('TitleNewGroup', 'مجموعة جديدة');
define('TitleViewGroup', 'عرض المجموعة');

define('AttachmentComplete', 'تم.');

define('TestButton', 'تجربة');
define('AutoCheckMailIntervalLabel', 'التحقق الياً مو وجود رسائل جديدة كل');
define('AutoCheckMailIntervalDisableName', 'بدون');
define('ReportCalendarSaved', 'تم حفظ التقويم.');

define('ContactSyncError', 'فشل مزامنة');
define('ReportContactSyncDone', 'تم اكتمال المزامنة');

define('MobileSyncUrlTitle', 'Mobile sync URL');
define('MobileSyncLoginTitle', 'Mobile sync login');

define('QuickReply', 'رد سريع');
define('SwitchToFullForm', 'فتح نموذج الرد الكامل');
define('SortFieldDate', 'التاريخ');
define('SortFieldFrom', 'من');
define('SortFieldSize', 'الحجم');
define('SortFieldSubject', 'الموضوع');
define('SortFieldFlag', 'علم');
define('SortFieldAttachments', 'مرفقات');
define('SortOrderAscending', 'تصاعدي');
define('SortOrderDescending', 'تنازلي');
define('ArrangedBy', 'الترتيب حسب');

define('MessagePaneToRight', 'عرض الرسالة بجانب قائمة الرسائل');

define('SettingsTabMobileSync', 'تزامن الجوال');

define('MobileSyncContactDataBaseTitle', 'قاعدة بيانات جهات الاتصال لمزامنة الجوال');
define('MobileSyncCalendarDataBaseTitle', 'قاعدة بيانات التقويم لمزامنة الجوال');
...
define('MobileSyncEnableLabel', 'تمكين مزامنة الجوال');

define('SearchInputText', 'بحث');
...
define('Searching', 'جاري البحث&hellip;');

define('ButtonSetupSpecialFolders', 'إعدادات المجلدات الخاصة');
define('ButtonSaveChanges', 'حفظ التغييرات');
...
define('AccountOldPassword', 'كلمة المرور الحالية');
define('AccountOldPasswordsDoNotMatch', 'كلمة المرور الحالية غير صحيحة');

define('DefEditor', 'المحرر الافتراضي');
define('DefEditorRichText', 'المحرر المتطور');
define('DefEditorPlainText', 'المحرر النصي');

define('Layout', 'اسلوب العرض');

define('TitleNewMessagesCount', '%count% رسالة جديدة');

define('AltOpenInNewWindow', 'في فتح نافذة جديدة');

define('SearchByFirstCharAll', 'الكل');
...
define('FileUploaderClickToAttach', 'اضغط هنا لارفاق ملف');
define('FileUploaderOrDragNDrop', 'أو قم بمجرد سحب وإسقاط الملف هنا');

define('AutoCheckMailInterval1Minute', 'دقيقة واحدة');
define('AutoCheckMailInterval3Minutes', '3 دقائق');
define('AutoCheckMailInterval5Minutes', '5 دقائق');
define('AutoCheckMailIntervalMinutes', 'دقيقة');

define('ReadAboutCSVLink', 'Learn more on .CSV file fields');

define('VoiceMessageSubj', 'رسالة صوتية');
